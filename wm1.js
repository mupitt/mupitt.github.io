...
console.log('Script ini dibuat oleh: inmufyd | IG: @rayyarrr');
console.log('Lihat Script HTML Lainnya di www.inmufyd.id');
...
watermark.style = "color:white;opacity:.4;font-size:10px;position:fixed;bottom:25px;left:25px;z-index:2";
